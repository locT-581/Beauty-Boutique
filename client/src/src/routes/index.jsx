...
const FlowerRecognitionApp = lazy(() => import("../components/FlowerRecognitionApp"));
...
const publicRouter = [
  ...
  { path: "/wiki-chi-tiet", element: DetailWiki, layout: DefaultLayout },

  { path: "/tin-tuc", element: News, layout: DefaultLayout },



  { path: "*", element: () => <div>Page not found</div>, layout: null },

  { path: "/tim-hoa-bang-hinh-anh", element: FlowerRecognitionApp, layout: DefaultLayout },
];
